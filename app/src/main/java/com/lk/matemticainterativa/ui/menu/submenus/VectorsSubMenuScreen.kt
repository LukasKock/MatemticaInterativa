...
import com.lk.matemticainterativa.MainActivity.Companion.numberOfVectorActivities
...
fun VectorsSubMenuScreen(navController: NavController) {
    ...
    LazyColumn(modifier = Modifier
        ...
        for(vectorActivityNumber in 1..numberOfVectorActivities){
            item {
                MenuItem("Exercício ${vectorActivityNumber}") {
                    navController.navigate("vectors/${vectorActivityNumber}")
                }
            }
        }
    }
