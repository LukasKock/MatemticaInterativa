                    ...
                    onDrag = { change, dragAmount ->
                        ...
                        when(selectedVector){
                            1 -> {
                                ...
                                else if(abs(delta2.x) < threshold && abs(delta2.y) < threshold &&
                                ...
                                else if(abs(delta3.x) < threshold && abs(delta3.y) < threshold &&
                                ...
                                else if(abs(delta4.x) < threshold && abs(delta4.y) < threshold &&
